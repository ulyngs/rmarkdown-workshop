...
--
- `pandoc` looks for stuff wrapped in dollar signs and will try to plug in content from your **.Rmd** file
...
.center[
# Time for practice!
Examples: Output customisation ( [Rmd](https://github.com/ulyngs/rmarkdown-workshop-2019/blob/master/examples/output_customisation.Rmd), [HTML](../examples/output_customisation.html)) ; Using LaTeX templates ([Rmd](https://github.com/ulyngs/rmarkdown-workshop-2019/blob/master/examples/using_latex_templates.Rmd), [HTML](../examples/using_latex_templates.html))
]
...
--
Option 2: Knit to Word document > upload to Google Docs > comment and suggest edits there > manually integrate changes into .Rmd source file<sup>1</sup>


--
Option 3: Edit raw R Markdown on Google Docs
...
.col-4.beginner[
.color[
Make a report from scratch, using the **my-example-document** (this one will have the data computed in there)
]
...
.col-4.intermediate[
11. .color[ake an your own template for a teaching situation relevan to your]


2.Look into RStudio Connect and suggest how it might be used in your teaching

]

.col-4.advanced[
1. Make a start on adjusting your favorite journal's LaTeX template for use with R Markdown
2. Figure out how the [Open Science Framework R package works](https://centerforopenscience.github.io/osfr/), and suggest how it might be useful
