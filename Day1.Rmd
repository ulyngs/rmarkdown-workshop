...
--
To make a cross-reference, use the syntax `\@ref(label)`. <br> **So we can refer to that number of the section above with `\@ref(my-section)`.** <br>
You can also use hyperlink syntax with \# before the label: `[see this section](#my-section)`
