...
- Final pieces: Citations, cross-referencing, captions
]
]
...
---
# Captions
- we've already seen how to apply these
- if you need fancy syntax in your caption, then you need to do so with a text reference (for 'complicated reasons')
