...
- Research: attention and self-control in relation to digital device use
]
--
.pull-right[
## R Markdown nerd
...
- Example paper here: [Self-Control in Cyberspace: Applying Dual Systems Theory to Self-Control Tools](https://osf.io/zyj4h/) 
...
- Final pieces: Cross-referencing, citations, captions
]
]
...
--
- You could keep code, results, and text in the same document?

--
- Your results and plots were automatically generated from your data, so your documents were automatically updated if your data changed?
...
---
class: center, middle, inverse
![](figures/rmarkdownoutputformats.png)
...
````markdown
`r ''````{r, fig.cap = "A ggplot of cars' speed and stopping distance"}
cars %>% 
  ggplot() +
    aes(x = speed, y = dist) +
    geom_point()
...
.caption[
A ggplot of cars' speed and stopping distance
]
...
--
Inside your text you can write code using the syntax <span>&#96;</span>r code here&#96;.
...
--
However, you can use the [`reticulate`](https://rstudio.github.io/reticulate/articles/r_markdown.html) package to insert variables from python chunks into your output.
...
- include a plot (e.g. with `plot(pressure)`)
- include a table (using the `kable` function)
...
---
background-image: url("figures/notebook-demo.png")
...
---
background-image: url("figures/plain-text.png")
background-position: 0% 0%
class: center, bottom, inverse
...
--
```{r}
knitr::include_graphics("figures/too-old.png")
```

---

background-image: url("figures/markdown.png")
