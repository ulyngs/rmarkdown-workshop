...
- The [`officer`](https://davidgohel.github.io/officer/) package - this one is about reading **.docx** and **.pptx** into R as an R object, manipulate it, and then save it again