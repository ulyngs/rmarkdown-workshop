...
--
- `pandoc` looks for stuff wrapped in dollar signs and assumes it means you want it to plug in content from your **.Rmd** file
...
--
2. Knit to Word document > upload to Google Docs > comment and suggest edits there > manually integrate changes into .Rmd source file<sup>1</sup>
